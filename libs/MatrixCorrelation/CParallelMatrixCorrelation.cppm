...
export module CParallelMatrixCorrelation;

export class CParallelMatrixCorrelation : public IMatrixCorrelationStrategy {
public:
...
*/
auto CParallelMatrixCorrelation::correlate(
    const int ny,
    const int nx,
    const float* const data,
    float *result
